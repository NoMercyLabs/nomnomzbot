...
(Kick / YouTube / X Live platform connections are decided scope — PRODUCT-ALIGNMENT D1–D3 — built in `SHORTCOMINGS-EXECUTION-PLAN.md` Tier 6; see *Multi-platform readiness* above.)
