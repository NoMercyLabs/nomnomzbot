...
**Grounding:** LOCKED schema (`2026-06-16-database-schema.md` Domains O + Q, §5 GDPR story) · `2026-06-16-gdpr-and-data.md` · `2026-06-16-stack-and-dependencies.md` (Crypto/secrets decision) · `2026-06-16-decisions-resolved.md` (#10: O(1) ciphertext crypto-shred plus row-scrub, both in scope and specified here).
