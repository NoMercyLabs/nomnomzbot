...
val GiveawaysGlyph: ImageVector = navIcon("Giveaways") {
        addPath(
            pathData = addPathNodes("M4 8H20A1 1 0 0 1 21 9V11A1 1 0 0 1 20 12H4A1 1 0 0 1 3 11V9A1 1 0 0 1 4 8ZM12 8V21M19 12V19A2 2 0 0 1 17 21H7A2 2 0 0 1 5 19V12M7.5 8A2.5 2.5 0 0 1 7.5 3A4.8 8 0 0 1 12 8A4.8 8 0 0 1 16.5 3A2.5 2.5 0 0 1 16.5 8"),
            stroke = SolidColor(Color.Black),
            strokeLineWidth = SW,
            strokeLineCap = StrokeCap.Round,
            strokeLineJoin = StrokeJoin.Round,
...
// A media frame with a play triangle — the viewer clip/video queue (Media Share).
val MediaShareGlyph: ImageVector = navIcon("MediaShare") {
        addPath(
            pathData =
                addPathNodes(
                    "M3 8C3 6.34315 4.34315 5 6 5H18C19.6569 5 21 6.34315 21 8V16C21 17.6569 19.6569 19 18 19H6C4.34315 19 3 17.6569 3 16V8Z M10 9.5L15 12L10 14.5V9.5Z"
                ),
            stroke = SolidColor(Color.Black),
            strokeLineWidth = SW,
            strokeLineCap = StrokeCap.Round,
...
// A shield with a check — the personal GDPR "My data" self-service plane.
val MyDataGlyph: ImageVector = navIcon("MyData") {
        addPath(
            pathData =
                addPathNodes(
                    "M12 3L5 6V11C5 15.4183 8.13401 19.5 12 21C15.866 19.5 19 15.4183 19 11V6L12 3Z M9 12L11 14L15 10"
                ),
            stroke = SolidColor(Color.Black),
            strokeLineWidth = SW,
            strokeLineCap = StrokeCap.Round,
...
// An isometric package — a portable bundle pack (export / import / marketplace).
val BundlesGlyph: ImageVector = navIcon("Bundles") {
        addPath(
            pathData =
                addPathNodes(
                    "M12 2L20 6.5V17.5L12 22L4 17.5V6.5L12 2Z M4 6.5L12 11M12 11L20 6.5M12 11V22"
                ),
            stroke = SolidColor(Color.Black),
            strokeLineWidth = SW,
            strokeLineCap = StrokeCap.Round,
