...
namespace NomNomzBot.Infrastructure.Platform.Persistence.Migrations
{
    ...
    public partial class AddSongRequestQueueItemCode : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // guarantees uniqueness within a channel without a retry loop.
            migrationBuilder.Sql(
                ...
                coded AS (
                    SELECT
                        "Id",
                        substr('ACDEFGHJKMNPQRTUVWXY34679', (((n / 15625) % 25) + 1)::int, 1) ||
                        substr('ACDEFGHJKMNPQRTUVWXY34679', (((n / 625) % 25) + 1)::int, 1) ||
                        substr('ACDEFGHJKMNPQRTUVWXY34679', (((n / 25) % 25) + 1)::int, 1) ||
                        substr('ACDEFGHJKMNPQRTUVWXY34679', ((n % 25) + 1)::int, 1) AS code
                    FROM ranked
                )
                UPDATE "SongRequestQueueItems" t
                SET "Code" = coded.code
                FROM coded
                WHERE coded."Id" = t."Id" AND t."Code" = '';
                """
            );
        }
