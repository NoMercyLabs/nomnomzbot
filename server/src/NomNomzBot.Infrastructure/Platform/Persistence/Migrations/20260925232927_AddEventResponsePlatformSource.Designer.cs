...
namespace NomNomzBot.Infrastructure.Platform.Persistence.Migrations
{
    ...
    [Migration("20260925232927_AddEventResponsePlatformSource")]
    partial class AddEventResponsePlatformSource
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Assets.Entities.ChannelAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Automation.Entities.AutomationApiToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AllowedPipelineIdsJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Billing.Entities.TenantLimitOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BroadcasterId", "LimitKey")
                        .IsUnique()
                        .HasFilter("\"DeletedAt\" IS NULL");

                    b.ToTable("TenantLimitOverrides");
                });
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Commands.Entities.PipelineRunState", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("WaitTimeoutAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Commands.Entities.VoiceTranscriptSegment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StreamId", "SpokenAt");

                    b.ToTable("VoiceTranscriptSegments");
                });

            modelBuilder.Entity("NomNomzBot.Domain.Commands.Entities.VoiceTrigger", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("StartingCount")
                        .HasColumnType("integer");

                    b.Property<Guid?>("StickerAssetId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VoiceTriggers");
                });

            modelBuilder.Entity("NomNomzBot.Domain.Community.Entities.ChatPoll", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Community.Entities.ChatPollVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("VoterProvider")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.HasIndex("PollId", "VoterProvider", "VoterUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("NomNomzBot.Domain.CustomEvents.Entities.CustomDataSource", b =>
                {
                    ...
                    b.Property<string>("LastFieldErrorsJson")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Giveaways.Entities.Giveaway", b =>
                {
                    ...
                    b.Property<DateTime?>("ScheduledCloseAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Identity.Entities.SecurityNotice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Moderation.Entities.ChannelModerationStanding", b =>
                {
                    ...
                    b.HasIndex("BroadcasterId", "Standing");

                    b.HasIndex("BroadcasterId", "Provider", "UserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Moderation.Entities.NetworkBlock", b =>
                {
                    ...
                    b.Property<Guid>("AppliedByPrincipalId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("LiftAttemptedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("LiftFailedChannelIds")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.Property<string>("LiftJustification")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<Guid?>("LiftedByPrincipalId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("RestoredChannelCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Moderation.Entities.SpamSignature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("Corroborations")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NomNomzBot.Domain.Stream.Entities.ShoutoutOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
