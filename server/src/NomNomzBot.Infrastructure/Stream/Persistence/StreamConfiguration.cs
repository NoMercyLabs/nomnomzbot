...
public class StreamConfiguration : IEntityTypeConfiguration<Domain.Stream.Entities.Stream>
{
    public void Configure(EntityTypeBuilder<Domain.Stream.Entities.Stream> builder)
    {
