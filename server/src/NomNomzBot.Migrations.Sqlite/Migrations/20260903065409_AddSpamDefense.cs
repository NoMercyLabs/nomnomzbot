        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnforcementEligibleAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    SemiTrustedWatchHoursHere = table.Column<double>(type: "REAL", nullable: false),
                    SemiTrustedWatchHoursInstance = table.Column<double>(
                        type: "REAL",
                        nullable: false
                    ),
                    NearDuplicateSimilarity = table.Column<double>(type: "REAL", nullable: false),
                    MinimumSkeletonLength = table.Column<int>(type: "INTEGER", nullable: false),
                    NonLatinScriptGate = table.Column<bool>(type: "INTEGER", nullable: false),
                    QualifyNoStandingShare = table.Column<double>(type: "REAL", nullable: false),
                    DequalifyNoStandingShare = table.Column<double>(type: "REAL", nullable: false),
                    ...
                    AutoReverseOnDequalify = table.Column<bool>(type: "INTEGER", nullable: false),
                    FollowSpikeFactor = table.Column<double>(type: "REAL", nullable: false),
                    JoinBurstFactor = table.Column<double>(type: "REAL", nullable: false),
                    LockdownMinutes = table.Column<int>(type: "INTEGER", nullable: false),
                    LockdownAutoExtend = table.Column<bool>(type: "INTEGER", nullable: false),
                    LockdownMaxMinutes = table.Column<int>(type: "INTEGER", nullable: false),
                    NetworkSubscribe = table.Column<bool>(type: "INTEGER", nullable: false),
                    NetworkContribute = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Signals = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ...
                    OverturnedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
