...
/// "declare every DbSet, auto-ignore the unmapped ones" shape of <see cref="ChatFiltersControllerTestDbContext"/>.
/// </summary>
internal sealed class BillingTierChangeTestDbContext : DbContext, IApplicationDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        b.Entity<Domain.Commands.Entities.Timer>(e => e.HasKey(t => t.Id));
    ...
    public DbSet<ModerationEscalationPolicy> ModerationEscalationPolicies =>
        throw new NotSupportedException();
    public DbSet<ModerationEscalationState> ModerationEscalationStates =>
        throw new NotSupportedException();
    ...
    public DbSet<Domain.Music.Entities.BlockedTrack> BlockedTracks =>
        throw new NotSupportedException();
    public DbSet<PickList> PickLists => throw new NotSupportedException();
    ...
    public DbSet<ViewerReport> ViewerReports => throw new NotSupportedException();
