...
internal sealed class ChatFiltersControllerTestDbContext : DbContext, IApplicationDbContext
{
    ...
    public DbSet<ChannelModerationStanding> ChannelModerationStandings =>
        throw new NotSupportedException();
    public DbSet<SharedBanSettings> SharedBanSettings =>
        throw new NotSupportedException();
    public DbSet<SharedBanTrustedChannel> SharedBanTrustedChannels =>
        throw new NotSupportedException();
    public DbSet<NetworkNukeBatch> NetworkNukeBatches =>
        throw new NotSupportedException();
    public DbSet<UserModerationHistory> UserModerationHistories =>
        throw new NotSupportedException();
    public DbSet<UserTrustScore> UserTrustScores =>
        throw new NotSupportedException();
    ...
    public DbSet<ViewerReport> ViewerReports =>
        throw new NotSupportedException();
